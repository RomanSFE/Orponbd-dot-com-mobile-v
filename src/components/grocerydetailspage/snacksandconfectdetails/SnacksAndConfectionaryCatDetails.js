...
import './snacksandconfectcatdetails.css';
...
export default class SnacksAndConfectionaryCatDetails extends Component {
        ...
        return (
            ...
            <div className="obd-grocery-details-products-hed-txt-section-det">
                <div className="container">
                    <div className="row">
                        <div className="col-md-12">
                            <div className="djfhdsjfhh-snacks-and-confe">
                                <div className="row">
