...
export default class StoreAllNewArrivalProd extends Component {
    render() {
        return (
            <>
            <Search/>
             <div className="store-new-arrival-products-all-mv-secz">
                        ...
                        <div className="col-md-12">
                            <div className="store-new-arrival-products-mv-secz-bbox">
                                <div className="store-new-arrival-products-mv-sec-hd-lnk">
                                    ...
                                    <Link to="/store-details"><span>Back Store <i className="fa fa-angle-right"></i></span></Link>
                                </div>
                                {/* Single item */}
                                ...
                                <div className="row">
                                    <div className="col-md-12">
                                        <div className="store-newarrivl-products-all-load-mr text-center">
