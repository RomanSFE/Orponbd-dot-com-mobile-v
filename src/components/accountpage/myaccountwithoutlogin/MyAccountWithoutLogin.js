...
import './myaccountwithoutlogin.css';
...
export default class MyAccountWithoutLogin extends Component {
                        ...
                        <div className="row">
                            <div className="col-3">
                                <div className="myaccount-main-page-vv-mm-profile-img-section-immg">
                                    <img src={require('../../../assets/avatar-img-w-login.png')} alt="orponbd global collections"/>
                                </div>
                            </div>
                            <div className="col-9">
